        ...
        if len(kwargs) == 1 and 'handle' in kwargs:
            ...
            if len(args) > 0:
                if not isinstance(args[0], _collections_abc.Iterable):
                    raise TypeError(
                        'Slice_bool.__init__ takes a sequence as argument')
                for elt in args[0]:
                    self.append(elt)
    ...
    def __getitem__(self, key):
        if isinstance(key, slice):
            if key.step is None or key.step == 1:
                ...
                return Slice_bool(
                    handle=_api.Slice_bool_subslice(self.handle, st, ed))
    ...
    def __init__(self, *args, **kwargs):
        ...
        if len(kwargs) == 1 and 'handle' in kwargs:
            ...
            if len(args) > 0:
                if not isinstance(args[0], _collections_abc.Iterable):
                    raise TypeError(
                        'Slice_byte.__init__ takes a sequence as argument')
                for elt in args[0]:
                    self.append(elt)
    ...
    def __getitem__(self, key):
        if isinstance(key, slice):
            if key.step is None or key.step == 1:
                ...
                return Slice_byte(
                    handle=_api.Slice_byte_subslice(self.handle, st, ed))
            return [self[ii] for ii in range(*key.indices(len(self)))]
        elif isinstance(key, int):
            if key < 0:
                key += len(self)
...
class Slice_error(GoClass):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if len(kwargs) == 1 and 'handle' in kwargs:
            ...
            if len(args) > 0:
                if not isinstance(args[0], _collections_abc.Iterable):
                    raise TypeError(
                        'Slice_error.__init__ takes a sequence as argument')
                for elt in args[0]:
                    self.append(elt)
    ...
    def __getitem__(self, key):
        if isinstance(key, slice):
            if key.step is None or key.step == 1:
                ...
                return Slice_error(
                    handle=_api.Slice_error_subslice(self.handle, st, ed))
            return [self[ii] for ii in range(*key.indices(len(self)))]
        elif isinstance(key, int):
            if key < 0:
                key += len(self)
    ...
    def __iadd__(self, value):
        if not isinstance(value, _collections_abc.Iterable):
            raise TypeError(
                'Slice_error.__iadd__ takes a sequence as argument')
        for elt in value:
            self.append(elt)
        return self
...
class Slice_float32(GoClass):
        ...
        if isinstance(key, slice):
            if key.step is None or key.step == 1:
                ...
                return Slice_float32(
                    handle=_api.Slice_float32_subslice(self.handle, st, ed))
            return [self[ii] for ii in range(*key.indices(len(self)))]
        elif isinstance(key, int):
            if key < 0:
                key += len(self)
    ...
    def __iadd__(self, value):
        if not isinstance(value, _collections_abc.Iterable):
            raise TypeError(
                'Slice_float32.__iadd__ takes a sequence as argument')
        for elt in value:
            self.append(elt)
        return self
...
class Slice_float64(GoClass):
        ...
        if isinstance(key, slice):
            if key.step is None or key.step == 1:
                ...
                return Slice_float64(
                    handle=_api.Slice_float64_subslice(self.handle, st, ed))
            return [self[ii] for ii in range(*key.indices(len(self)))]
        elif isinstance(key, int):
            if key < 0:
                key += len(self)
    ...
    def __iadd__(self, value):
        if not isinstance(value, _collections_abc.Iterable):
            raise TypeError(
                'Slice_float64.__iadd__ takes a sequence as argument')
        for elt in value:
            self.append(elt)
        return self
    ...
    def __init__(self, *args, **kwargs):
        ...
        if len(kwargs) == 1 and 'handle' in kwargs:
            ...
            if len(args) > 0:
                if not isinstance(args[0], _collections_abc.Iterable):
                    raise TypeError(
                        'Slice_int.__init__ takes a sequence as argument')
                for elt in args[0]:
                    self.append(elt)
    ...
    def __getitem__(self, key):
        if isinstance(key, slice):
            if key.step is None or key.step == 1:
                ...
                return Slice_int(
                    handle=_api.Slice_int_subslice(self.handle, st, ed))
            return [self[ii] for ii in range(*key.indices(len(self)))]
        elif isinstance(key, int):
            if key < 0:
                key += len(self)
...
class Slice_int16(GoClass):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if len(kwargs) == 1 and 'handle' in kwargs:
            ...
            if len(args) > 0:
                if not isinstance(args[0], _collections_abc.Iterable):
                    raise TypeError(
                        'Slice_int16.__init__ takes a sequence as argument')
                for elt in args[0]:
                    self.append(elt)
    ...
    def __getitem__(self, key):
        if isinstance(key, slice):
            if key.step is None or key.step == 1:
                ...
                return Slice_int16(
                    handle=_api.Slice_int16_subslice(self.handle, st, ed))
            return [self[ii] for ii in range(*key.indices(len(self)))]
        elif isinstance(key, int):
            if key < 0:
                key += len(self)
    ...
    def __iadd__(self, value):
        if not isinstance(value, _collections_abc.Iterable):
            raise TypeError(
                'Slice_int16.__iadd__ takes a sequence as argument')
        for elt in value:
            self.append(elt)
        return self
...
class Slice_int32(GoClass):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if len(kwargs) == 1 and 'handle' in kwargs:
            ...
            if len(args) > 0:
                if not isinstance(args[0], _collections_abc.Iterable):
                    raise TypeError(
                        'Slice_int32.__init__ takes a sequence as argument')
                for elt in args[0]:
                    self.append(elt)
    ...
    def __getitem__(self, key):
        if isinstance(key, slice):
            if key.step is None or key.step == 1:
                ...
                return Slice_int32(
                    handle=_api.Slice_int32_subslice(self.handle, st, ed))
            return [self[ii] for ii in range(*key.indices(len(self)))]
        elif isinstance(key, int):
            if key < 0:
                key += len(self)
    ...
    def __iadd__(self, value):
        if not isinstance(value, _collections_abc.Iterable):
            raise TypeError(
                'Slice_int32.__iadd__ takes a sequence as argument')
        for elt in value:
            self.append(elt)
        return self
...
class Slice_int64(GoClass):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if len(kwargs) == 1 and 'handle' in kwargs:
            ...
            if len(args) > 0:
                if not isinstance(args[0], _collections_abc.Iterable):
                    raise TypeError(
                        'Slice_int64.__init__ takes a sequence as argument')
                for elt in args[0]:
                    self.append(elt)
    ...
    def __getitem__(self, key):
        if isinstance(key, slice):
            if key.step is None or key.step == 1:
                ...
                return Slice_int64(
                    handle=_api.Slice_int64_subslice(self.handle, st, ed))
            return [self[ii] for ii in range(*key.indices(len(self)))]
        elif isinstance(key, int):
            if key < 0:
                key += len(self)
    ...
    def __iadd__(self, value):
        if not isinstance(value, _collections_abc.Iterable):
            raise TypeError(
                'Slice_int64.__iadd__ takes a sequence as argument')
        for elt in value:
            self.append(elt)
        return self
    ...
    def __init__(self, *args, **kwargs):
        ...
        if len(kwargs) == 1 and 'handle' in kwargs:
            ...
            if len(args) > 0:
                if not isinstance(args[0], _collections_abc.Iterable):
                    raise TypeError(
                        'Slice_int8.__init__ takes a sequence as argument')
                for elt in args[0]:
                    self.append(elt)
    ...
    def __getitem__(self, key):
        if isinstance(key, slice):
            if key.step is None or key.step == 1:
                ...
                return Slice_int8(
                    handle=_api.Slice_int8_subslice(self.handle, st, ed))
            return [self[ii] for ii in range(*key.indices(len(self)))]
        elif isinstance(key, int):
            if key < 0:
                key += len(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        if len(kwargs) == 1 and 'handle' in kwargs:
            ...
            if len(args) > 0:
                if not isinstance(args[0], _collections_abc.Iterable):
                    raise TypeError(
                        'Slice_rune.__init__ takes a sequence as argument')
                for elt in args[0]:
                    self.append(elt)
    ...
    def __getitem__(self, key):
        if isinstance(key, slice):
            if key.step is None or key.step == 1:
                ...
                return Slice_rune(
                    handle=_api.Slice_rune_subslice(self.handle, st, ed))
            return [self[ii] for ii in range(*key.indices(len(self)))]
        elif isinstance(key, int):
            if key < 0:
                key += len(self)
...
class Slice_string(GoClass):
    ...
    def __getitem__(self, key):
        if isinstance(key, slice):
            if key.step is None or key.step == 1:
                ...
                return Slice_string(
                    handle=_api.Slice_string_subslice(self.handle, st, ed))
            return [self[ii] for ii in range(*key.indices(len(self)))]
        elif isinstance(key, int):
            if key < 0:
                key += len(self)
    ...
    def __iadd__(self, value):
        if not isinstance(value, _collections_abc.Iterable):
            raise TypeError(
                'Slice_string.__iadd__ takes a sequence as argument')
        for elt in value:
            self.append(elt)
        return self
    ...
    def __init__(self, *args, **kwargs):
        ...
        if len(kwargs) == 1 and 'handle' in kwargs:
            ...
            if len(args) > 0:
                if not isinstance(args[0], _collections_abc.Iterable):
                    raise TypeError(
                        'Slice_uint.__init__ takes a sequence as argument')
                for elt in args[0]:
                    self.append(elt)
    ...
    def __getitem__(self, key):
        if isinstance(key, slice):
            if key.step is None or key.step == 1:
                ...
                return Slice_uint(
                    handle=_api.Slice_uint_subslice(self.handle, st, ed))
            return [self[ii] for ii in range(*key.indices(len(self)))]
        elif isinstance(key, int):
            if key < 0:
                key += len(self)
...
class Slice_uint16(GoClass):
    ...
    def __getitem__(self, key):
        if isinstance(key, slice):
            if key.step is None or key.step == 1:
                ...
                return Slice_uint16(
                    handle=_api.Slice_uint16_subslice(self.handle, st, ed))
            return [self[ii] for ii in range(*key.indices(len(self)))]
        elif isinstance(key, int):
            if key < 0:
                key += len(self)
    ...
    def __iadd__(self, value):
        if not isinstance(value, _collections_abc.Iterable):
            raise TypeError(
                'Slice_uint16.__iadd__ takes a sequence as argument')
        for elt in value:
            self.append(elt)
        return self
...
class Slice_uint32(GoClass):
    ...
    def __getitem__(self, key):
        if isinstance(key, slice):
            if key.step is None or key.step == 1:
                ...
                return Slice_uint32(
                    handle=_api.Slice_uint32_subslice(self.handle, st, ed))
            return [self[ii] for ii in range(*key.indices(len(self)))]
        elif isinstance(key, int):
            if key < 0:
                key += len(self)
    ...
    def __iadd__(self, value):
        if not isinstance(value, _collections_abc.Iterable):
            raise TypeError(
                'Slice_uint32.__iadd__ takes a sequence as argument')
        for elt in value:
            self.append(elt)
        return self
...
class Slice_uint64(GoClass):
    ...
    def __getitem__(self, key):
        if isinstance(key, slice):
            if key.step is None or key.step == 1:
                ...
                return Slice_uint64(
                    handle=_api.Slice_uint64_subslice(self.handle, st, ed))
            return [self[ii] for ii in range(*key.indices(len(self)))]
        elif isinstance(key, int):
            if key < 0:
                key += len(self)
    ...
    def __iadd__(self, value):
        if not isinstance(value, _collections_abc.Iterable):
            raise TypeError(
                'Slice_uint64.__iadd__ takes a sequence as argument')
        for elt in value:
            self.append(elt)
        return self
...
class Slice_uint8(GoClass):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if len(kwargs) == 1 and 'handle' in kwargs:
            ...
            if len(args) > 0:
                if not isinstance(args[0], _collections_abc.Iterable):
                    raise TypeError(
                        'Slice_uint8.__init__ takes a sequence as argument')
                for elt in args[0]:
                    self.append(elt)
    ...
    def __getitem__(self, key):
        if isinstance(key, slice):
            if key.step is None or key.step == 1:
                ...
                return Slice_uint8(
                    handle=_api.Slice_uint8_subslice(self.handle, st, ed))
            return [self[ii] for ii in range(*key.indices(len(self)))]
        elif isinstance(key, int):
            if key < 0:
                key += len(self)
    ...
    def __iadd__(self, value):
        if not isinstance(value, _collections_abc.Iterable):
            raise TypeError(
                'Slice_uint8.__iadd__ takes a sequence as argument')
        for elt in value:
            self.append(elt)
        return self
