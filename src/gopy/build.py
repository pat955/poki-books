...
add_checked_function(mod, 'api_NoTitleError_New', retval('char*'), [param('int64_t', '_handle'), param('char*', 'message')])
...
add_checked_function(mod, 'api_NoContentError_New', retval('char*'), [param('int64_t', '_handle'), param('char*', 'message')])
