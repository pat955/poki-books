...
mod.add_function('Slice_api_Book_len', retval('int'), [param('int64_t', 'handle')])
mod.add_function('Slice_api_Book_elem', retval('int64_t'), [param('int64_t', 'handle'), param('int', 'idx')])
mod.add_function('Slice_api_Book_subslice', retval('int64_t'), [param('int64_t', 'handle'), param('int', 'st'), param('int', 'ed')])
mod.add_function('Slice_api_Book_set', None, [param('int64_t', 'handle'), param('int', 'idx'), param('int64_t', 'value')])
mod.add_function('Slice_api_Book_append', None, [param('int64_t', 'handle'), param('int64_t', 'value')])
...
mod.add_function('api_NoContentError_Message_Get', retval('char*'), [param('int64_t', 'handle')])
mod.add_function('api_NoContentError_Message_Set', None, [param('int64_t', 'handle'), param('char*', 'val')])
add_checked_string_function(mod, 'api_NoContentError_Error', retval('char*'), [param('int64_t', '_handle')])
mod.add_function('api_NoPathError_CTor', retval('int64_t'), [])
mod.add_function('api_NoPathError_Message_Get', retval('char*'), [param('int64_t', 'handle')])
mod.add_function('api_NoPathError_Message_Set', None, [param('int64_t', 'handle'), param('char*', 'val')])
add_checked_string_function(mod, 'api_NoPathError_Error', retval('char*'), [param('int64_t', '_handle')])
...
mod.add_function('api_Book_Path_Get', retval('char*'), [param('int64_t', 'handle')])
mod.add_function('api_Book_Path_Set', None, [param('int64_t', 'handle'), param('char*', 'val')])
mod.add_function('api_Book_Title_Get', retval('char*'), [param('int64_t', 'handle')])
mod.add_function('api_Book_Title_Set', None, [param('int64_t', 'handle'), param('char*', 'val')])
mod.add_function('api_Book_Content_Get', retval('char*'), [param('int64_t', 'handle')])
mod.add_function('api_Book_Content_Set', None, [param('int64_t', 'handle'), param('char*', 'val')])
mod.add_function('api_Book_Extension_Get', retval('char*'), [param('int64_t', 'handle')])
mod.add_function('api_Book_Extension_Set', None, [param('int64_t', 'handle'), param('char*', 'val')])
mod.add_function('api_Book_Notes_Get', retval('char*'), [param('int64_t', 'handle')])
mod.add_function('api_Book_Notes_Set', None, [param('int64_t', 'handle'), param('char*', 'val')])
mod.add_function('api_Book_Author_Get', retval('char*'), [param('int64_t', 'handle')])
mod.add_function('api_Book_Author_Set', None, [param('int64_t', 'handle'), param('char*', 'val')])
add_checked_function(mod, 'api_GetBookByPath', retval('int64_t'), [param('char*', 'db_path'), param('char*', 'path')])
add_checked_function(mod, 'api_AddBook', retval('char*'), [param('char*', 'db_path'), param('int64_t', 'book')])
add_checked_function(mod, 'api_AddNotesByPath', retval('char*'), [param('char*', 'db_path'), param('char*', 'notes'), param('char*', 'path')])
add_checked_function(mod, 'api_RemoveBook', retval('char*'), [param('char*', 'db_path'), param('char*', 'path')])
add_checked_function(mod, 'api_ResetNotes', retval('char*'), [param('char*', 'db_path')])
...
add_checked_string_function(mod, 'api_GetNotesByPath', retval('char*'), [param('char*', 'db_path'), param('char*', 'path')])
add_checked_function(mod, 'api_ResetTable', retval('char*'), [param('char*', 'dp_path')])
