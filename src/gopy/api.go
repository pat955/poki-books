...
//export api_NoTitleError_New
func api_NoTitleError_New(_handle CGoHandle, message *C.char) *C.char {
	_saved_thread := C.PyEval_SaveThread()
	vifc, __err := gopyh.VarFromHandleTry((gopyh.CGoHandle)(_handle), "*api.NoTitleError")
	if __err != nil {
		return errorGoToPy(nil)
	}
	__err = gopyh.Embed(vifc, reflect.TypeOf(api.NoTitleError{})).(*api.NoTitleError).New(C.GoString(message))
...
//export api_NoContentError_New
func api_NoContentError_New(_handle CGoHandle, message *C.char) *C.char {
	_saved_thread := C.PyEval_SaveThread()
	vifc, __err := gopyh.VarFromHandleTry((gopyh.CGoHandle)(_handle), "*api.NoContentError")
	if __err != nil {
		return errorGoToPy(nil)
	}
	__err = gopyh.Embed(vifc, reflect.TypeOf(api.NoContentError{})).(*api.NoContentError).New(C.GoString(message))
