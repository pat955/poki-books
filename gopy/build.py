# python build stubs for package database
...
mod = Module('_database')
mod.add_include('"database_go.h"')
...
mod.add_function('Slice_Ptr_sql_ColumnType_CTor', retval('int64_t'), [])
mod.add_function('Slice_Ptr_sql_ColumnType_len', retval('int'), [param('int64_t', 'handle')])
mod.add_function('Slice_Ptr_sql_ColumnType_elem', retval('int64_t'), [param('int64_t', 'handle'), param('int', 'idx')])
mod.add_function('Slice_Ptr_sql_ColumnType_subslice', retval('int64_t'), [param('int64_t', 'handle'), param('int', 'st'), param('int', 'ed')])
mod.add_function('Slice_Ptr_sql_ColumnType_set', None, [param('int64_t', 'handle'), param('int', 'idx'), param('int64_t', 'value')])
mod.add_function('Slice_Ptr_sql_ColumnType_append', None, [param('int64_t', 'handle'), param('int64_t', 'value')])
...
mod.add_function('Slice_database_Book_CTor', retval('int64_t'), [])
mod.add_function('Slice_database_Book_len', retval('int'), [param('int64_t', 'handle')])
mod.add_function('Slice_database_Book_elem', retval('int64_t'), [param('int64_t', 'handle'), param('int', 'idx')])
mod.add_function('Slice_database_Book_subslice', retval('int64_t'), [param('int64_t', 'handle'), param('int', 'st'), param('int', 'ed')])
mod.add_function('Slice_database_Book_set', None, [param('int64_t', 'handle'), param('int', 'idx'), param('int64_t', 'value')])
mod.add_function('Slice_database_Book_append', None, [param('int64_t', 'handle'), param('int64_t', 'value')])
...
add_checked_function(mod, 'database_DBTX_ExecContext', retval('int64_t'), [param('int64_t', '_handle'), param('int64_t', 'arg_0'), param('char*', 'arg_1'), param('int64_t', 'arg_2')])
add_checked_function(mod, 'database_DBTX_PrepareContext', retval('int64_t'), [param('int64_t', '_handle'), param('int64_t', 'arg_0'), param('char*', 'arg_1')])
add_checked_function(mod, 'database_DBTX_QueryContext', retval('int64_t'), [param('int64_t', '_handle'), param('int64_t', 'arg_0'), param('char*', 'arg_1'), param('int64_t', 'arg_2')])
add_checked_function(mod, 'database_DBTX_QueryRowContext', retval('int64_t'), [param('int64_t', '_handle'), param('int64_t', 'arg_0'), param('char*', 'arg_1'), param('int64_t', 'arg_2')])
mod.add_function('database_Queries_CTor', retval('int64_t'), [])
add_checked_function(mod, 'database_Queries_CreateBook', retval('int64_t'), [param('int64_t', '_handle'), param('int64_t', 'ctx'), param('int64_t', 'arg')])
add_checked_function(mod, 'database_Queries_GetAllBooks', retval('int64_t'), [param('int64_t', '_handle'), param('int64_t', 'ctx')])
add_checked_function(mod, 'database_Queries_GetBookByID', retval('int64_t'), [param('int64_t', '_handle'), param('int64_t', 'ctx'), param('char*', 'id')])
add_checked_string_function(mod, 'database_Queries_GetContentByID', retval('char*'), [param('int64_t', '_handle'), param('int64_t', 'ctx'), param('char*', 'id')])
add_checked_string_function(mod, 'database_Queries_GetContentByTitle', retval('char*'), [param('int64_t', '_handle'), param('int64_t', 'ctx'), param('char*', 'title')])
add_checked_function(mod, 'database_Queries_WithTx', retval('int64_t'), [param('int64_t', '_handle'), param('int64_t', 'tx')])
mod.add_function('database_Book_CTor', retval('int64_t'), [])
mod.add_function('database_Book_Title_Get', retval('char*'), [param('int64_t', 'handle')])
mod.add_function('database_Book_Title_Set', None, [param('int64_t', 'handle'), param('char*', 'val')])
mod.add_function('database_Book_Content_Get', retval('char*'), [param('int64_t', 'handle')])
mod.add_function('database_Book_Content_Set', None, [param('int64_t', 'handle'), param('char*', 'val')])
mod.add_function('database_CreateBookParams_CTor', retval('int64_t'), [])
mod.add_function('database_CreateBookParams_Title_Get', retval('char*'), [param('int64_t', 'handle')])
mod.add_function('database_CreateBookParams_Title_Set', None, [param('int64_t', 'handle'), param('char*', 'val')])
mod.add_function('database_CreateBookParams_Content_Get', retval('char*'), [param('int64_t', 'handle')])
mod.add_function('database_CreateBookParams_Content_Set', None, [param('int64_t', 'handle'), param('char*', 'val')])
add_checked_function(mod, 'database_New', retval('int64_t'), [param('int64_t', 'db')])

mod.generate(open('database.c', 'w'))
